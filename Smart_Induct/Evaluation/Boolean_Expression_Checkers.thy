...
theorem val_reduce: 
  ...
  by2 (induction t arbitrary: s env)
...
lemma val_normif: 
  ...
  by2 (induct t arbitrary: t1 t2 s env)
...
lemma same_val_if_reduced:
  ...
  by2 (induction t arbitrary: X) auto
...
theorem reduced_ifex: 
  "reduced (ifex_of b) {}"
  by2 (induction b) (simp add: Let_def; metis keys_empty reduced_normif)+
