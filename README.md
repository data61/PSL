...
- smart_induct: Smart Induction for Isabelle/HOL (Tool Paper) submitted to [FMCAD2020](https://fmcad.forsyte.at/FMCAD20/)  (The draft is available at [GitHub](https://github.com/data61/PSL/blob/master/Smart_Induct/document/smart_induct.pdf).).
- Simple Dataset for Proof Method Recommendation in Isabelle/HOL (Dataset Description) accepted at [CICM2020](https://cicm-conference.org/2020/cicm.php) (The preprint is available at [arXiv](https://arxiv.org/abs/2004.10667).)
