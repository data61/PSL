...
text {*
  ...
  onto @{term W}. In the @{text "CoxeterSystem"} locale below, this correspondence will be assumed
...
subsubsection {* The Coxeter system associated to a thin chamber complex with many foldings *}
...
subsubsection {* Locale and complex definitions *}
...
subsubsection {* As a simplicial complex *}
...
subsubsection {* As a chamber complex *}

text {* Now we verify that a Coxeter complex is a chamber complex. *}
...
subsubsection {* The Coxeter complex associated to a thin chamber complex with many foldings *}
