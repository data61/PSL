...
imports Main "HOL-Library.Multiset" "../../PaMpeR" "../Assertion_Checker"
begin
...
lemma [mono]: "case_prod f p = f (fst p) (snd p)"  assert_nth_false 78 assert_nth_false 79 assert_nth_false 80 by (simp add: split_def)
