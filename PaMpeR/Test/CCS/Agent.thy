...
*)
theory Agent
  imports "HOL-Nominal.Nominal" "../Assertion_Checker"
begin
...
| "coAction (\<tau>) = \<tau>"
by(rule TrueI)+
print_theorems find_theorems name:"coAction"
lemma coActionEqvt[eqvt]:
  fixes p :: "name prm"
  and   a :: act

  shows "(p \<bullet> coAction a) = coAction(p \<bullet> a)" assert_nth_true 78 assert_nth_true 79 assert_nth_true 80
