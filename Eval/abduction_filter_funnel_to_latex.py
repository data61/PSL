#!/usr/bin/env python3
r"""Generate black-and-white PGFPlots figures for Pure AbductionProver filter statistics.
...
def write_notes(out_dir, benchmark, problem_order):
    ...
    text = (
        "Interpretation of the Pure AbductionProver filter-attrition figures\n"
        "==============================================================\n\n"
...
def main():
    ...
    parser.add_argument(
        ...
        help="Method to plot from abduction_statistics.csv. Defaults to pure 'abduction' (Pure AbductionProver). Use 'preprocessed_abduction' for the Combo Prover's Abduction phase after TBC seeding, or 'all' for diagnostics.",
    )
    parser.add_argument(
        "--problem-order",
