...
\node[prt, dashed, line width=1pt, right = of e_11] (p_12) {$key\_gen$};
\node[prt, dashed, line width=1pt,] (p_22) {$ \mathcal{A}_1$};
\node[prt, dashed, line width=1pt,] (p_32) {$\mathit{encrypt}$};
...
\draw[draw=gray, dashed, line width=1pt] 
  ($(e_13.north west)+(3pt,-3pt)$) 
    rectangle  node[font=\fontsize{20}{20}\selectfont] (o_13) {Oracle} 
  ($(e_23.south east)+(-3pt,33pt)$);

\node[ins, above = -10pt of e_11] (ins_1) {$\mathit{pk}, \mathit{sk}$};
...
\draw[latex-latex] (p_12.east) -| ++(20pt,0) |- ($(o_13.west)+(-13pt,15pt)$);
\draw[latex-latex] (p_22.east) -| ++(25pt,0) |- ($(o_13.west)+(-13pt,5pt)$);
\draw[latex-latex] (p_32.east) -| ++(30pt,0) |- ($(o_13.west)+(-13pt,-5pt)$);
\draw[latex-latex] (p_42.east) -| ++(35pt,0) |- ($(o_13.west)+(-13pt,-15pt)$);
...
\end{tikzpicture}
\caption{Graphic representation of the generic IND-CPA game.}
\label{fig:1}
\end{figure}
