...
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_1"                                                                                                                           ) (SeLFiE_Assertion.lifter_1                                                                                                                           , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_1b"                                                                                                                          ) (SeLFiE_Assertion.lifter_1b                                                                                                                          , 1) \<close>
...
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_4"                                                                                                                           ) (SeLFiE_Assertion.lifter_4                                                                                                                           , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_5"                                                                                                                           ) (SeLFiE_Assertion.lifter_5                                                                                                                           , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_6"                                                                                                                           ) (SeLFiE_Assertion.lifter_6                                                                                                                           , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_7"                                                                                                                           ) (SeLFiE_Assertion.lifter_7                                                                                                                           , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_8"                                                                                                                           ) (SeLFiE_Assertion.lifter_8                                                                                                                           , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_9"                                                                                                                           ) (SeLFiE_Assertion.lifter_9                                                                                                                           , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_10"                                                                                                                          ) (SeLFiE_Assertion.lifter_10                                                                                                                          , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_11"                                                                                                                          ) (SeLFiE_Assertion.lifter_11                                                                                                                          , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_12"                                                                                                                          ) (SeLFiE_Assertion.lifter_12                                                                                                                          , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_13"                                                                                                                          ) (SeLFiE_Assertion.lifter_13                                                                                                                          , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_14"                                                                                                                          ) (SeLFiE_Assertion.lifter_14                                                                                                                          , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_15"                                                                                                                          ) (SeLFiE_Assertion.lifter_15                                                                                                                          , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "lifter_20"                                                                                                                          ) (SeLFiE_Assertion.lifter_20                                                                                                                          , 1) \<close>
...
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "generalize_arguments_used_in_recursion"                                                                                             ) (SeLFiE_Assertion.generalize_arguments_used_in_recursion                                                                                             , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "for_all_arbs_there_should_be_a_change"                                                                                              ) (SeLFiE_Assertion.for_all_arbs_there_should_be_a_change                                                                                              , 1) \<close>
...
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "ind_on_lhs_of_eq_then_arb_on_rhs_of_eq"                                                                                             ) (SeLFiE_Assertion.ind_on_lhs_of_eq_then_arb_on_rhs_of_eq                                                                                             , 1) \<close>
...
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "outer_induct_on_arg_of_set_member_n_set_outer"                                                                                      ) (SeLFiE_Assertion.outer_induct_on_arg_of_set_member_n_set_outer                                                                                      , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "induct_on_arg_of_set_member_n_set_syntax_only"                                                                                      ) (SeLFiE_Assertion.induct_on_arg_of_set_member_n_set_syntax_only                                                                                      , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "induct_on_2nd_arg_of_map_outer"                                                                                                     ) (SeLFiE_Assertion.induct_on_2nd_arg_of_map_outer                                                                                                     , 1) \<close>
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "structural_induction_on_an_arg_of_inductive_defined_constant_in_the_concl_of_meta_imp"                                              ) (SeLFiE_Assertion.structural_induction_on_an_arg_of_inductive_defined_constant_in_the_concl_of_meta_imp                                              , 1) \<close>
...
setup\<open> Apply_SeLFiE.update_assert (Test_Heuristic,    "generalize_all_free_var_not_inducted_on"                                                                                            ) (SeLFiE_Assertion.generalize_all_free_var_not_inducted_on                                                                                            , 1) \<close>
