...
lemma sorted_wrt_dist_last_take_mono:
  ...
  using assms unfolding sorted_wrt_dist_def by2 (induction ps arbitrary: n) (auto simp add: take_Cons')
...
lemma sorted_wrt_dist_last_insort_key_eq:
  ...
  using assms unfolding sorted_wrt_dist_def by2 (induction ps) (auto)
...
lemma sorted_nns:
  ...
  using sorted_wrt_dist_nbors by2 (induction kdt arbitrary: ps) (auto simp: Let_def)
